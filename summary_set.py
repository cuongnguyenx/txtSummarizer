...
class SummaryFrame:
    ...
    def __init__(self, url, master):
        ...
        self.back_button = Button(self.prog2, text="RETURN", justify=tk.CENTER, height=5, pady=5,
                                  command=self.backToGrid, bg="red", font=("Verdana", 20, 'bold'))
    ...
    def getSmryCustom(self, event):
        ...
        self.status, self.title, self.sentences, self.scores, self.bound = lxrTest.generateSummary(link, 'custom')
