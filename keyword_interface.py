...
class keywordFrame:
    ...
    def __init__(self, *args):
        ...
        self.bg1 = Label(self.frame_bottom, image=self.bg_image)
...
class summaryFrame_Key:
    ...
    def __init__(self, *args):
        ...
        # self.lbl_smry = Label(self.prog1, text="Output Summary: ", bg=config.bg_color, font=("Verdana", 12, 'bold'), relief=tk.SUNKEN)
